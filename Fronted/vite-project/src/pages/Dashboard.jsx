...
export default function Dashboard() {
  ...
  return (
    <div className="pt-24 pb-12 px-4 max-w-7xl mx-auto min-h-screen">
      <h1 className="text-4xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 animate-fade-in-down">Featured Projects</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          {projects.map((project, index) => (
            <Link
              ...
              className="group block h-full project-card opacity-0 translate-y-8 transition-all duration-700 ease-out"
